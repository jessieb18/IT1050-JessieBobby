...
namespace Lab04
{
    class Program
    {
        ...
        {
            /* The four basic elements are the controlled variable, the initial value of the control variable, 
            ...
            For repitition which specifies the elements of counter controlled repetition in a single line of code; 
            ...
            In the while statements, the app tests the loop continuation condition at the beginning of the loop, before executing the loop's body. If the condition is false, the body doesn't execute. 
            ...
            */
            ...
            Console.WriteLine("insert a temp");
