...
namespace Midterm
{
    class Program
    {
        ...
        {
            // There are 3 types of control structures that we use to order statements in our programs. They are: selection statements, which consist of if, else, switch, and case branching,
            ...
            // If the program used a while statement, it would not output anything.
